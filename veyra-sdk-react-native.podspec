...
veyra_kmp_version  = "1.0.5" # VEYRA-KMP-VERSION-MARKER (pinned by the release train)
veyra_kmp_zip_url  = "https://repo.veyra.co/releases/files/VeyraKMP-1.0.5.xcframework.zip" # VEYRA-KMP-URL-MARKER
